...
<img src={src} className='md:w-full md:p-0 sm:px-28 sm:py-6'/>
</div>)}
   ...
   <button onClick={()=>addProductToCart(id)} className='btn cursor-pointer ms-5 mt-5  '>Add To Cart</button>
...
{allProduct?.map((product)=>
 <div key={product._id} className='w-full box  mb-10 lg:mt-16 sm:mt-5 rounded-2xl  sm:w-1/2   lg:w-1/6 '>
<div data-aos="zoom-out-right">
 <div  className='product lg:p-4 sm:p-6 ' >
